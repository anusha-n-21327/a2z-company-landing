        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="order-2 lg:order-1 space-y-6">
            <div className="flex items-center gap-4">
              <div className="inline-block rounded-full bg-cyan-900/50 p-3 border border-cyan-500/30">
            ...
            <div className="space-y-4 text-slate-400 md:text-lg">
              <p>
          ...
          <div className="order-1 lg:order-2 flex justify-center">
            <img
              ...
              alt="Our Mission"
              className="w-full max-w-md rounded-lg shadow-2xl [box-shadow:0_0_30px_theme(colors.cyan.500/20)]"
            />
          </div>
        </div>
      </div>
